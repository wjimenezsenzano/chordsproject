...
public class chordsDetector {
    ...
    static String[] parseTab(String input) {
        ...
        if (input.contains(" ")) {
            ...
            if (input.length() != 6) {
                throw new IllegalArgumentException("Must be 6 strings (e.g. x02220)");
            }
    ...
    static List<ChordCandidate> detectChord(String tab, String[] tuning) {
        ...
        int bassIndex = noteList.isEmpty() ? -1 : noteList.get(0);
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Tab (x02220, x 0 2 2 2 0, x,10,12,...): ");
